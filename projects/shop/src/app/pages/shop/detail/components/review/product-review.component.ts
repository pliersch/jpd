...
import {
  CommentsComponent
} from '@shop/pages/shop/detail/components/review/comments/comments.component';
import {
  NewReviewDialogComponent
} from '@shop/pages/shop/detail/components/review/new-review/new-review-dialog.component';
import {
  StarRatingComponent
} from '@shop/pages/shop/detail/components/review/star-rating/star-rating.component';
