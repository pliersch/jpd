...
const notFound = () => import('./components/not-found/not-found.component').then((x) => x.default);

export default [
  {
    path: '',
    component: ShopPageComponent,
    // resolve: {category: productCategoryResolver},
    children: [
      {
        path: 'kratom', loadComponent: productPage, children: [
          {path: '', loadComponent: productCategory, data: {animation: 'heroes'}},
          {path: 'detail/:id', loadComponent: productDetail, data: {animation: 'hero'}},
          {path: 'white-vein', loadComponent: productCategory, data: {animation: 'heroes'}},
          {path: 'green-vein', loadComponent: productCategory, data: {animation: 'heroes'}},
          {path: 'red-vein', loadComponent: productCategory, data: {animation: 'heroes'}},
