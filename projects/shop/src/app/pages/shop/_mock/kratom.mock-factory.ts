...
function createKratomArticle(name: string, product: Category, category: string, dealer: DealerType, id: string): Kratom {
  return {
    ...
    dealer: dealer,
    data: [
      {index: 0, identifier: 10, price: 2, stock: 20},
      {index: 1, identifier: 50, price: 8.5, stock: 25},
      {index: 2, identifier: 100, price: 15.45, stock: 22},
      {index: 3, identifier: 250, price: 30.5, stock: 17},
      {index: 4, identifier: 500, price: 50, stock: 11},
      {index: 5, identifier: 1000, price: 80, stock: 33},
    ],
