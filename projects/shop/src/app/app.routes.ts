...
const cart = () => import('@shop/pages/shop/cart/cart.component').then((x) => x.CartComponent);
...
export const ROUTES: Route[] = [
  ...
  {path: 'kasse', title: 'Kasse', loadComponent: checkout},
  {path: 'warenkorb', title: 'Warenkorb', loadComponent: cart},
