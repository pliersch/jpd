...
@Component({
  ...
  standalone: true,
  imports: [MatSidenavModule, MatListModule, NgFor, RouterLink, RouterLinkActive, RouterOutlet, AsyncPipe, NgIf,  NgClass, NgTemplateOutlet, MatButtonModule, SidenavComponent]
})
